"use strict";
(self["webpackChunkto_do_list"] = self["webpackChunkto_do_list"] || []).push([["sidePanel"],{
...
/* harmony import */ var _todoEditor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./todoEditor */ "./src/todoEditor.js");
...
function addScreen () {
    ...
    const list = (0,_script_js__WEBPACK_IMPORTED_MODULE_0__.projectList)();

    //submit button 
    submit.addEventListener('click',()=>{
        const newItem = new _script_js__WEBPACK_IMPORTED_MODULE_0__.Projects(nameInput.value, descInput.value);
        list.add(newItem);
...
function projectElement(projects){
    ...
    projects.forEach(element => {
        ...
        newB.addEventListener('click',()=>{
            ...
            todoEditor.appendChild((0,_todoEditor__WEBPACK_IMPORTED_MODULE_1__.TDEditor)());
        });
